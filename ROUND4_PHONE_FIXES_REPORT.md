...
**Bundle commit:** `90a88dc` (`Pin Settings to exact CI head`)

**Android workflow:** [GitHub Actions run 35589802813](https://github.com/noradbolus3/Empire-rush/actions/runs/35589802813)
...
|---|---|---|---|
| Tap upgrade cost and ROI curve | **Fixed** | `src/engine/tapUpgradeEngine.ts` now uses `cost = round(160 × 1.4^level)` and `gain = min(25 − currentValue, 0.5 × 1.08^level)`. This preserves the user-observed level-17 cost at approximately **$48,786** while making the next gain **+$1.85**, not a flat +$0.50. The tap cap is **$25.00**. Home displays `UPGRADE LEVEL … · +$1.85 NEXT` and `MAX $25.00`. | **Partial**: verified in source and regression; a superseding APK is being rebuilt for this preserved-cost curve, and no physical device screenshot was possible in this sandbox. |
...
The final corrected-cap Round 4 APK was downloaded from the successful workflow `35589802813` and verified locally.

- File: `empire-rush-round4-debug.apk`
- Size: approximately 252 MB
- SHA-256: `db64653dbc79f731bc28f93d09c6fa275bb24a4ffe7f39ae31274937eb41b5fa`
